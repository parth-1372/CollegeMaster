...
const isNotActiveStyle =
  "flex items-center px-5 gap-3 text-white hover:text-black transition-all duration-200 ease-in-out capitalize hover:bg-gray-200 py-2 my-1"; // Updated to text-white
const isActiveStyle =
...
const Sidebar = () => {
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={sidebarRef}
        className={`fixed top-0 left-0 h-full bg-black text-white transition-transform duration-300 z-40 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} md:relative md:translate-x-0 md:flex-[0.2]`} // Updated to bg-black text-white
      >
        <div className="space-y-8 overflow-y-scroll scrollbar-thin scrollbar-track-black scrollbar-thumb-gray-300 h-[33rem]">
          <div className="">
            <NavLink
              to="/faculty/home"
              className={({ isActive }) =>
          ...
          <div className="">
            <NavLink
              to="/faculty/addstudymaterial"
              className={({ isActive }) =>
                isActive ? isActiveStyle : isNotActiveStyle
              }
            >
              <EngineeringIcon />
              <h1 className="font-normal">Add StudyMaterial</h1>
            </NavLink>
            <NavLink
              to="/faculty/getAllStudyMaterial"
              className={({ isActive }) =>
                isActive ? isActiveStyle : isNotActiveStyle
              }
            >
              <EngineeringIcon />
              <h1 className="font-normal">Uploaded StudyMaterial</h1>
            </NavLink>
          </div>
