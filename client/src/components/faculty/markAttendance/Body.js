...
//           <h1>All Students</h1>
//         </div>
//         <div className="mr-10 bg-white grid grid-cols-1 md:grid-cols-4 rounded-xl pt-6 pl-6 h-auto">
//           <form
//             className="flex flex-col space-y-2 col-span-1"
//             onSubmit={handleSubmit}>
//             <label htmlFor="department">Department</label>
...
//               Object.keys(error).length === 0 &&
//               students?.length !== 0 && (
//                 <div className={`${classes.adminData} h-auto`}>
...
//                     <div
//                       key={idx}
//                       className={`${classes.adminDataBody} grid grid-cols-1 md:grid-cols-7`}>
//                       <input
//                         onChange={handleInputChange}
//                         value={stu._id}
//                         className="col-span-1 border-2 w-16 h-4 mt-3 px-2"
...
//     year: "",
//     section: "",
//     subject: "", // Added subject field here
//   });
//   const [search, setSearch] = useState(false);
...
//       setError(store.errors);
//       setLoading(false);
//       setValue({ department: "", year: "", section: "", subject: "" });
//     }
//   }, [store.errors]);
...
//                 setSubjectName(e.target.value); // Set the subject name
//               }}>
//               <MenuItem value="">None</MenuItem>
//               {subjects?.map((subject, idx) => (
//                 <MenuItem key={idx} value={subject.name}>
//                   {subject.name}
//                 </MenuItem>
//               ))}
//             </Select>
        ...
        <div className="mr-10 bg-white grid grid-cols-1 md:grid-cols-4 rounded-xl pt-6 pl-6 h-auto">
          ...
          >
            ...
            <Select
              required
              displayEmpty
              sx={{ height: 36 }} // Use default width for responsive
              inputProps={{ "aria-label": "Without label" }}
              value={value.department}
              onChange={(e) =>
                setValue({ ...value, department: e.target.value })
            ...
            <button
              className={`${classes.adminFormSubmitButton} w-full md:w-56`}
              type="submit"
            >
              Search
            </button>
          ...
          <div className="col-span-1 md:col-span-3 mr-6">
            ...
            {search && Object.keys(error).length === 0 && (
              <div className="space-x-3 flex items-center justify-center mt-5">
                ...
                <button
                  onClick={uploadAttendance}
                  className={`${classes.adminFormSubmitButton} w-28`}
                >
                  Upload
                </button>
              </div>
