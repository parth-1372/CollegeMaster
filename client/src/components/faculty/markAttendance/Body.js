  ...
  return (
    <div className="flex-[0.8] mt-3">
      <div className="space-y-5">
        ...
        <div className="mr-10 bg-white rounded-xl pt-6 pl-6 h-auto grid grid-cols-1 md:grid-cols-4">
          <form className="flex flex-col space-y-2 md:col-span-1" onSubmit={handleSubmit}>
            ...
            <button className={`${classes.adminFormSubmitButton} w-full md:w-56`} type="submit">
              Search
            </button>
          </form>
          ...
          <div className="col-span-1 md:col-span-3 mr-6">
            ...
            {search && !loading && Object.keys(error).length === 0 && students?.length !== 0 && (
              <div className={`${classes.adminData} h-auto`}>
                ...
                {/* Desktop table rows */}
                {students?.map((stu, idx) => (
                  <div key={idx} className={`${classes.adminDataBody} hidden md:grid md:grid-cols-7`}>
                    <input
                      onChange={handleInputChange}
                      value={stu._id}
