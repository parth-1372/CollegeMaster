...
const Body = () => {
  ...
  return (
    <div className="flex-[0.8] mt-3 bg-black text-white"> {/* Applied black bg and white text */}
      <div className="space-y-5">
        <div className="flex items-center space-x-2 text-white"> {/* Ensured AddIcon and text are white */}
          <AddIcon />
          <h1>Create Test</h1>
        </div>
        <div className="mr-10 bg-black flex flex-col rounded-xl">
          <form className={classes.adminForm0} onSubmit={handleSubmit}>
            <div className={classes.adminForm1}>
              <div className={classes.adminForm2l}>
                <div className={classes.adminForm3}>
