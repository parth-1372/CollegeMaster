    ...
    <div className="flex-[0.8] mt-3">
      <div className="space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mr-5">
          <div className="bg-neutral-900 h-[8rem] rounded-xl shadow-lg flex items-center space-x-4 px-8">
          ...
          <div className=" h-[8rem] rounded-xl shadow-lg flex items-center space-x-4 px-8 bg-neutral-900">
        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 bg-neutral-900">
          {/* Calendar */}
          <div className="bg-neutral-900 h-[17rem] rounded-xl shadow-lg w-full md:w-1/3">
            <Calendar onChange={onChange} value={value} className="custom-calendar" />
          </div>

          {/* Notices */}
          <div className="bg-neutral-900 h-[17rem] rounded-xl shadow-lg w-full md:w-2/3 flex flex-col pt-3 bg-neutral-900">
