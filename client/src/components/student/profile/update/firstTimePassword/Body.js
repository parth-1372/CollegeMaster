...
const Body = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full space-y-10 mt-24 bg-black text-white">
      <form onSubmit={update} className="flex flex-col space-y-6 items-center">
        <h1 className="text-white text-3xl font-bold">Update Password</h1>
        <div className="space-y-1">
          <p className="text-gray-300 font-bold text-sm">New Password</p>
          <div className="bg-gray-800 rounded-lg px-3 flex items-center space-x-3 w-full">
            <input
              onChange={(e) => setNewPassword(e.target.value)}
              value={newPassword}
              required
              type={showPassword ? "text" : "password"}
              className=" bg-gray-800 text-white rounded-lg outline-none py-2  placeholder:text-sm"
              placeholder="New Password"
            />
            {showPassword ? (
              <VisibilityOffIcon
        ...
        <div className="space-y-1">
          <p className="text-gray-300 font-bold text-sm">Confirm Password</p>
          <div className="bg-gray-800 rounded-lg px-3 flex items-center space-x-3 w-full">
            <input
              onChange={(e) => setConfirmPassword(e.target.value)}
              value={confirmPassword}
