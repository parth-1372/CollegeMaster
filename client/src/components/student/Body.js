...
//   return (
//     <div className="flex-[0.8] mt-3 px-4 md:px-8">
//       <div className="space-y-5">
//         <div className="flex text-gray-400 items-center space-x-2">
//           <HomeIcon />
//           <h1>Dashboard</h1>
...
//           {/* <div className="bg-white h-[8rem] rounded-xl shadow-lg grid grid-cols-2 sm:grid-cols-4 gap-4 md:px-8 items-center">
//             <div className="flex items-center space-x-4 border-r-2 pr-4">
//               <EngineeringIcon
//                 className="rounded-full py-2 bg-orange-300"
//                 sx={{ fontSize: 40 }}
//               />
