...
//Add feedback
export const feedback = (feedbackform) => 
  API.post("/api/student/feedback",feedbackform);

export const feedbackA = (feedbackform) => 
  API.post("/api/admin/feedback",feedbackform);